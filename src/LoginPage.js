      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-12 items-center justify-center">
        <div className="max-w-xl text-center">
          <div className="mb-8 inline-flex p-4 rounded-full bg-white/10 backdrop-blur-sm">
            <div className="flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 shadow-xl">
          ...
          <p className="text-xl text-white/80 mb-8">Platformă completă de management a documentelor și apelurilor</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 text-left">
              ...
              <h3 className="text-white font-medium">Gestiune Completă</h3>
              <p className="text-white/70 text-sm">Management eficient al documentelor</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 text-left">
              ...
              <h3 className="text-white font-medium">Statistici Avansate</h3>
              <p className="text-white/70 text-sm">Analize și rapoarte detaliate</p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center justify-center mb-8 lg:hidden">
            <div className="flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-xl mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">PBX CRM</h1>
            <p className="text-gray-600 text-center">
              Platformă completă de management
            </p>
          </div>
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="py-3 pl-10 pr-4 block w-full border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                    required
                  />
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="py-3 pl-10 pr-10 block w-full border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                    required
                  />
